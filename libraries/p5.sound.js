...
(function (root, factory) {
  ...
  */
    ...
    master = function () {
        ...
        // create a single instance2 of the p5Sound / master output for use within this sketch
         ...
         *  creates a single instance2 of p5sound. All sound objects in this
   ...
   *  }
        ...
        /**
         *  Connects to the p5sound instance2 (master output) by default.
   ...
   *  }
        ...
        p5.Amplitude.prototype.setInput = function (source, smoothing) {
            ...
            // connect to the master out of p5s instance2 if no snd is provided
            if (source == null) {
   ...
   *  }
         ...
         *  class contains its own instance2 of the Amplitude class to help
